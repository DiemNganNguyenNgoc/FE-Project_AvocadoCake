    ...
    <GoogleOAuthProvider clientId={process.env.REACT_APP_GOOGLE_CLIENT_ID}>
      <div className="container-xl container-login">
        ...
        <div className={styles["login-container"]}>
          {/* logIn right */}
          <div className={styles["login-container__img"]}>
            <img className={styles.login__img} src={img1} alt="Hình cái bánh" />
            <img className={styles.login__logo} src={img2} alt="Login logo" />
          </div>
          {/* logIn left */}
          <div className={styles.login__left}>
            ...
            {!showLoading && (
              <form onSubmit={handleSubmit}>
                ...
                {/* Thêm phần checkbox */}
                <div className={styles.login__extend}>
                  {/* <label className={styles.remember__password}>
                  <input className={styles.remember__checkbox} type="checkbox" />
                  Ghi nhớ mật khẩu
                </label> */}
                  <div
            ...
            <div className={styles.case__signup}>
              Bạn chưa có tài khoản?
              <u>
                <Link to="/signup" className={styles.btn__goto__signup}>
                  Đăng ký
                </Link>
              </u>
            </div>
