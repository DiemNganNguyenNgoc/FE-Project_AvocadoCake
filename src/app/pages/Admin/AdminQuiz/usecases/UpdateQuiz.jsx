...
const UpdateQuiz = ({ onBack }) => {
  const { currentQuiz, updateQuiz, setLoading, setError } = useQuizStore();
  ...
  useEffect(() => {
    if (currentQuiz) {
      setQuizData(new QuizModel(currentQuiz));
    }
  }, [currentQuiz]);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-900">Sửa Quiz</h2>
          <button
            onClick={onBack}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
            ...
            >
              {saving ? "Đang cập nhật..." : "Cập nhật Quiz"}
            </button>
          </div>
        </form>
      </div>
