...
const AddNews = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const validation = validateNews({ ...formData, isCreating: true });
    ...
    try {
      setLoading(true);
      await NewsService.createNewNews(formData);
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`w-full px-5 py-4 text-base border-2 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all ${
            ...
            <div>
              <label className="block text-base font-semibold text-gray-800 mb-3">
                Ảnh tin tức <span className="text-red-500">*</span>
              </label>
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full px-5 py-4 text-base border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 bg-gray-50 focus:bg-white"
              >
        ...
        <div className="px-8 py-6 border-t border-gray-100 bg-gray-50">
          <div className="flex justify-end gap-4">
            ...
            <button
              ...
              className="px-8 py-3 text-base font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all disabled:opacity-50"
              disabled={loading}
            >
